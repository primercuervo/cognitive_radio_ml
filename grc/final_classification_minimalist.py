...
# Generated: Sat Nov 11 23:37:44 2017
##################################################
...
class final_classification_minimalist(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/cuervo/thesis/data/final_pu/no_dc/scn_5_snr_15.dat', False)
        self.blocks_file_sink_0_0_3 = blocks.file_sink(gr.sizeof_float*1, 'nterframe_time_ch_3_scn_0.dat', False)
        self.blocks_file_sink_0_0_3.set_unbuffered(False)
        self.blocks_file_sink_0_0_2 = blocks.file_sink(gr.sizeof_float*1, 'nterframe_time_ch4_scn_0.dat', False)
        self.blocks_file_sink_0_0_2.set_unbuffered(False)
        self.blocks_file_sink_0_0_1 = blocks.file_sink(gr.sizeof_float*1, 'packet_rate_scn_0.dat', False)
        self.blocks_file_sink_0_0_1.set_unbuffered(False)
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_float*1, 'variance_scn_0.dat', False)
        self.blocks_file_sink_0_0_0.set_unbuffered(False)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_float*1, 'terframe_time_ch_2_scn_0.dat', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'nterframe_time_ch_1_scn_0.dat', False)
